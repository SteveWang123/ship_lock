...
<% List schemes = (List) request.getAttribute("schemes");%>
<c:set var="schemes" value="${schemes}" scope="session"/>
                                                ...
                                                <div id="member-tab" class="tab-pane">
                                                    <div class="clearfix">
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar"
                                                                     src="<c:url value="/resources/vendor/assets/avatars/user.jpg" />"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar"
                                                                     src="<c:url value="/resources/vendor/ace/assets/avatars/avatar2.png"/>"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Susan's avatar"
                                                                     src="<c:url value="/resources/vendor/ace/assets/avatars/avatar3.png" />"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Phil Doe's avatar"
                                                                     src="<c:url value="/resources/vendor/assets/avatars/avatar4.png"/>"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alexa Doe's avatar"
                                                                     src="<c:url value="/resources/vendor/assets/avatars/avatar1.png"/>"/>
                                                            </div>
                                                ...
                                                <div id="comment-tab" class="tab-pane">
                                                    <div class="comments">
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's Avatar"
                                                                     src="<c:url value="/resources/vendor/assets/avatars/avatar.png"/>"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Joe's Avatar"
                                                                     src="<c:url value="/resources/vendor/assets/avatars/avatar2.png"/>"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv commentdiv">
                                                            <div class="user">
                                                                <img alt="Rita's Avatar"
                                                                     src="<c:url value="/resources/vendor/assets/avatars/avatar3.png"/>"/>
                                                            </div>
